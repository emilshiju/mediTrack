...
import {
  deleteAssignedMedicationApi,
  findAssignedMedicationsApi,
} from "@/src/lib/api/client/medicationAssign/medicationAssignHandler";
...
const PatientManagement = () => {
  ...
  const [patientAssignedMedication, setPatientAssignedMedications] = useState<
    AssignedMedicationType[]
  >([]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      {isModalOpen && patientAssignedMedication && (
        <>
          <ListingModal
            data={patientAssignedMedication}
            close={handleCloseModal}
            name={namePatient}
            deleteAssign={handleDelete}
          />
        </>
      )}
    </div>
