...
export const createMedicationApi = async (values: MedicationType) => {
  try {
    const resCreateMedicationApi: resCustomType = await axiosClient.post(
      "/medications",
      values
    );
...
export const getAllMedicationApi = async () => {
  try {
    const resAllMedicationApi: resCustomType = await axiosClient.get(
      "/medications"
    );
...
export const getMedicationApi = async (id: string) => {
  try {
    const resMedicationApi: resCustomType = await axiosClient.get(
      `/medications/${id}`
    );
...
export const updateMedicationApi = async (
  id: string,
  values: MedicationType
) => {
  try {
    const resUpateMedicationApi: resCustomType = await axiosClient.patch(
      `/medications/${id}`,
      values
    );
...
export const deleteMedicationApi = async (id: string) => {
  try {
    const resDeleteMedicationApi: resCustomType = await axiosClient.delete(
      `/medications/${id}`
    );
